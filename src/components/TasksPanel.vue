            ...
            >
                <div class="delete-modal" @click.stop>
                    ...
                    <p class="delete-modal-description">
                        ...
                        <strong
                            >eliminar todas las
                            {{ tasks.length }} tareas</strong
                        >. Esta acción no se puede deshacer y se creará una
                        nueva tarea vacía.
                    </p>

                    <div class="delete-modal-input-group">
                        <label
                            for="delete-all-confirm"
                            class="delete-modal-label"
                        >
                        ...
                        <input
                            ...
                            @keyup.enter="
                                isDeleteAllEnabled && confirmDeleteAll()
                            "
                        />
                    </div>
